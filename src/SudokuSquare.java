...
public class SudokuSquare {
    ...
    public void setSquareValue(int newSquareValue) {
        ...
        if (squareValue != 0) {
            ...
            throw new Error("Square value is already " + squareValue);
        }

        if (possibleValues.find(newSquareValue) == -1) {
            possibleValues.print();
            throw new Error("ATTEMPTED TO SET SQUARE VALUE TO " + newSquareValue);
        }
